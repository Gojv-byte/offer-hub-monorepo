...
| `/orders/{id}/milestones` | <Badge variant="success">GET</Badge> | List order milestones |
| `/orders/{id}/milestones/{ref}/complete` | <Badge variant="primary">POST</Badge> | Complete a milestone |
